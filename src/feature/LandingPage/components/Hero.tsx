...
import { isBusinessDataAvailable } from '../../../localStorageKeys/localStoragefunctions';

export default function Hero() {

    const [getStatedPage, setGetStatedPage] = React.useState('/createBusiness');

    useEffect(() => {
      const businessInfo = isBusinessDataAvailable()
      return businessInfo ? setGetStatedPage('/billingPage') : setGetStatedPage('/createBusiness')
    },[])
    ...
    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link   to={getStatedPage} className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</Link>
