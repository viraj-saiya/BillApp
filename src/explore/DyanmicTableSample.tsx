...
export default function DynamicInvoiceTable() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      {/* Template and Column Management */}
      <div className="mb-4 flex flex-wrap gap-4 items-center justify-between">
        <div className="flex gap-2">
          ...
          <button
            onClick={() => loadTemplate('wholesale')}
        ...
        >
          ...
          {isEditingColumns ? 'Done' : 'Customize Columns'}
        </button>
      </div>
      ...
      {isEditingColumns && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
          <h3 className="font-medium mb-3">Manage Columns</h3>
          ...
          <div className="space-y-2">
            {columns.map((column) => (
              <div key={column.id} className="flex items-center gap-2 p-2 bg-white rounded border">
